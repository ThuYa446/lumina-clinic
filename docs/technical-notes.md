...
New bookings snapshot MMK and the 300 deposit. Existing booking and payment snapshots retain their original currency, amounts and instants, including any legacy THB records. This is a demo currency configuration change, with no exchange-rate conversion or rescheduling. Migration V5 updates the treatment catalogue to the requested MMK prices: 20,000 for Express facial (30 minutes), 45,000 for Signature facial (60 minutes), and 70,000 for Restorative body ritual (90 minutes). It does not change recorded deposits or payments.
